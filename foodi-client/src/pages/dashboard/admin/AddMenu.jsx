      ...
      <div>
        <form onSubmit={handleSubmit(onSubmit)}>          
              ...
              <div className="form-control">
                  ...
                  <textarea {...register("recipe", { required: true })} className="textarea textarea-bordered h-24" placeholder="Tell The Words Aout your Recipe"></textarea>
               </div>
               ...
               <div className="form-control w-full my-6">
                ...
                <button className='btn text-white bg-green px-6'>Add Item <FaUtensils/></button>
        </form>
      </div>
    </div>
  )
